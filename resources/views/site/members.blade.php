                                            ...
                                            @if ($member->facebook_url || $member->youtube_url)
                                                <div class="mt-5 flex flex-wrap gap-2">
                                                    @if ($member->facebook_url)
                                                        <a href="{{ $member->facebook_url }}" target="_blank" rel="noreferrer" class="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-[var(--color-border)] bg-white px-4 py-3 text-sm font-semibold text-slate-900 hover:bg-[var(--color-surface)]">
                                                    ...
                                                    @if ($member->youtube_url)
                                                        <a href="{{ $member->youtube_url }}" target="_blank" rel="noreferrer" class="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-[var(--color-border)] bg-white px-4 py-3 text-sm font-semibold text-slate-900 hover:bg-[var(--color-surface)]">
